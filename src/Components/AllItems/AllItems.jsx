...
const AllItems = () => {
    ...
    switch (category) {
        case "Routers":
            categoryText =
                "Here you can find all Routers and Range extenders listed on Compro System";
            break;
        case "WireLessAirBurds":
            categoryText =
                "Wireless Earbuds | True Wireless Stereo Earphones (TWS) | AirPods";
            break;
        case "HeadPhone":
        ...
        <div className="bg-[#f3f5f6] py-12 p-2">
            <div className="flex justify-center gap-12">
                ...
                <div className="border bg-white">
                    {category == "Routers" && <div className="router p-32"></div>}
                    <div className="px-6 py-6 space-y-3">
                        ...
                        {category == "Routers" && (
                            <>
                                <h3 className="text-base text-silver font-bold">
                                    Or Shop by Brand:
                                </h3>
                                <hr />
                            </>
                    ...
                    <div className="flex justify-between 2xl:px-6 p-2 2xl:py-4 items-center">
                        <h1 className="text-sm sm:block hidden">
                    ...
                    {style == "grid" && (
                        <>
                                    ...
                                    >
                                        <div>
                                            ...
                                            <div className="pt-5 space-y-2 cursor-pointer">
                                                ...
                                                <h2 className="text-base text-primary hover:text-secondery  font-semibold">
                                                    {ele.title}
                                                </h2>
                                            </div>
                                        </div>
                                        <div className="flex flex-col gap-3 space-y-2 justify-center">
                                            ...
                                            <div className="flex gap-2 items-center">
                                                <p
                                                    className={`text-lg font-medium ${index === 3 ||
                                                        index === 7 ||
                                                        index === 9 ||
                                                        index === 13
                                                        ? "text-red-500"
                                                ...
                                                <p className="text-base  line-through text-silver">
                                                    {ele.delprice}
                                                </p>
                                            </div>
                                            <button
                                                className={`w-full p-3 font-bold text-white text-sm ${index === 3 ||
                                                    index === 9 ||
                                                    index === 6 ||
                                                    index === 12
                                                    ? "bg-secondery"
                            ...
                            <div className="flex justify-between items-center p-3">
                                <h1 className="text-silver tracking-wider font-semibold">
                                    Prevs
                                </h1>
                                <ul className="flex justify-center gap-3 items-center">
                                    <li className="bg-secondery px-3 py-1 text-white">1</li>
                                    <li className="hover:bg-secondery px-3 py-1 hover:text-white">
                                        2
                                    </li>
                                    <li className="hover:bg-secondery px-3 py-1 hover:text-white">
                                        3
                                ...
                                <h1 className="text-primary tracking-wider font-semibold">
                                    Next
                                </h1>
                            </div>
                        </>
                                        ...
                                        <div className="flex flex-col lg:flex-row border justify-between lg:gap-16 gap-2 p-4 cursor-pointer px-3 items-center">
                                            <div className="flex flex-col lg:w-fit w-full  lg:flex-row justify-center  items-center lg:gap-6 gap-2 lg:p-4 p-2">
                                                <img
                                                    onMouseEnter={() => setHoveredIndex(index)}
                                                    onMouseLeave={() => setHoveredIndex(null)}
                                                    className="lg:w-60 w-full object-cover"
                                                    src={hoveredIndex === index ? ele.img2 : ele.img}
                                                    alt={ele.title}
                                                />
                                                <div className="space-y-3 lg:w-fit w-full">
                                                    ...
                                                    <div className="flex items-center gap-4">
                                                        <p
                                                            className={`text-lg font-medium ${index === 3 || index === 7
                                                                ? "text-red-500"
                                                                : "text-cyan-500"
                                                                }`}
                                                        >
                                                        ...
                                                        <p className="text-base text-silver  line-through">
                                                            {ele.delprice}
                                                        </p>
                                                    </div>
                                                </div>
                                            ...
                                            <div className="flex lg:justify-center justify-start items-center lg:w-fit w-full  flex-col gap-3">
                                                ...
                                                <button
                                                    ...
                                                    className="lg:w-40 w-full hover:bg-gray-100 font-bold text-sm border text-secondery p-2">
                                                    Quick view
                                                </button>
                                            </div>
                                        </div>
                    ...
                    {data.slice(59, 65).map((ele, index) => (
                        ...
                        >
                            ...
                            <div className="flex flex-col gap-3 space-y-2 justify-center">
                                ...
                                <div className="flex gap-2 items-center">
                                    <p
                                        className={`text-lg font-medium ${index === 3 || index === 7 || index === 9 || index === 13
                                            ? "text-red-500"
                                            : "text-cyan-500"
                                            }`}
                                    >
                                ...
                                <button
                                    className={`w-full p-3 font-bold text-white text-sm ${index === 3 || index === 9 || index === 2 || index === 5
                                        ? "bg-secondery"
                                        : "bg-silver"
                                        }`}
                                >
            ...
            {showDiv1 && selectedProduct && (
                <div className="bg-gray-800 bg-opacity-50 fixed inset-0 flex items-center justify-center">
                    <div className="bg-white p-16 xl:w-[60%] w-full rounded-md relative flex flex-col justify-evenly gap-12 md:flex-row">
                        ...
                        <div className="flex flex-col justify-between">
                            <div className="space-y-6">
                                ...
                                <p className="text-primary font-bold">
                                    Price :
                                    <span className="text-2xl text-secondery pl-4 font-semibold">
                                ...
                                <button className="bg-silver w-52 md:w-60 p-2 text-white font-bold">
                                    Sold out
                                </button>
                            </div>
                            <div

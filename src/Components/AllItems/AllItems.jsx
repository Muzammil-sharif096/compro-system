                ...
                {filterdata.map((ele, index) => (
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-3 space-y-2 justify-center">
                      ...
                      <button
                        className={`w-full p-3 font-bold text-white text-sm ${
                          index === 3 ||
                          index === 9 ||
                          index === 6 ||
                          index === 12
                  ...
                  <>
                    <div className="flex flex-col lg:flex-row border justify-between lg:gap-16 gap-2 p-4 cursor-pointer px-3 items-center">
                      ...
                      <div className="flex lg:justify-center justify-start items-center lg:w-fit w-full  flex-col gap-3">
                        ...
                        <button className="lg:w-40 w-full hover:bg-gray-100 font-bold text-sm border text-secondery p-2">
                          Quick view
                        </button>
                      </div>
                    </div>
            ...
            >
              ...
              <div className="flex flex-col gap-3 space-y-2 justify-center">
                ...
                <div className="flex gap-2 items-center">
                  <p
                    className={`text-lg font-medium ${
                      index === 3 || index === 7 || index === 9 || index === 13
                        ? "text-red-500"
                        : "text-cyan-500"
                    }`}
                  >
                ...
                <button
                  className={`w-full p-3 font-bold text-white text-sm ${
                    index === 3 || index === 9 || index === 2 || index === 5
                      ? "bg-secondery"
                      : "bg-silver"
                  }`}
                >
